<div class="h-full w-screen  text-white bg-gray-100 flex items-center flex-col justify-center">
        ...
        <form action="index.php?section=enregistrer" method="post" class="mb-6 flex flex-col h-3/4 w-1/4 rounded-xl bg-slate-300 p-10 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-50 border border-gray-100">
                    <div class="">
